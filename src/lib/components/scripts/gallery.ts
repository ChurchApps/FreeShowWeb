export const images = [
	{
		...
		name: 'Show',
		description:
			'Create a show for lyrics, presentations, events and more. Arrange slides, and create different layouts for the same song.'
	},
	{
		src: 'preview/media.webp',
		name: 'Media',
		description:
			'Show images and videos easily from the drawer. Drag them on your slides to set as background.'
	},
	{
		src: 'preview/edit.webp',
		name: 'Edit',
		description:
			'A powerful editor. Change the text font, size or color. Add outline and shadows, and much more. The possibilities are endless (almost)!'
	},
	{
	...
	},
	{
		...
		name: 'YouTube player',
		description:
			'No more dragging windows around or downloading videos. Just paste the link and play the video.'
	},
	{
	...
	},
	{
		...
		name: 'Stage',
		description:
			'Connect from any local device, by entering the IP and a set port. Create and edit multiple stage views.'
	},
	{
		src: 'preview/draw.webp',
		name: 'Draw',
		description:
			'Shine a light on your slides while presenting. Focus the audience, play with particles, or draw a beautiful drawing.'
	},
	{
	...
	},
	{
		...
		name: 'Scripture',
		description:
			'Import your own local bibles, or choose from over 200 bibles provided by API.Bible.'
	},
	{
