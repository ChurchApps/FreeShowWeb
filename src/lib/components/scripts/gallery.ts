export const images = [
	...
	{
		src: "preview/overlays.webp",
		name: "Overlays",
		description: "Play overlays that are placed on top of other content. Set a timeout to automatically hide again."
	},
	{
	...
	// 	name: "Calendar",
	// 	description: "A calendar for all your events. Select them and create a show with info about upcomming events. Or schedule actions to run automatically."
	// },
	{
