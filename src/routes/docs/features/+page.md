...
-   **Cloud Sync:** Sync all your data between computers.

## System requirements

The current version of FreeShow is built using **Chromium 138**, it should run on any OS/hardware that can run a modern browser, check out [the system requirements](https://support.google.com/chrome/a/answer/7100626).
