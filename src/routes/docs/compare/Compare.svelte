<script>
    ...
    const features = [
        ...
        { name: "Chords", info: "Add chords in text", programs: { fs: "{y}", pp: "{n}", ew: "{n}", vp: "{y}", ol: "{y}", pc: "{n}" } },
        ...
        { name: "NDI support", info: "Multiple outputs, useful for streaming", programs: { fs: "{y}", pp: "{y}", ew: "{y}", vp: "{n}", ol: "{n}", pc: "{n}" } },
