<script>
    ...
    import Badges from "../../src/components/Badges.svelte"
...
<section>
    <h2>Free Forever!</h2>
    <p>Yep that's right. It's free for anyone to use anywhere, forever. <Button href="/docs/introduction">Learn more here.</Button></p>
    <p>What are you waiting for? <Button href="/downloads">Download the program</Button> and try it out!</p>
    <br />
    <h2>Support?</h2>
    ...
    <p>
        So please feel free to <Button href="https://reviews.capterra.com/new/251606/25c379b8-6a14-4583-bab4-d458913d407c" target="_blank">review FreeShow on Capterra</Button>, and
        receive a $20 Amazon gift card. Or press any of the badges below.
    </p>
</section>
